  ...
  return (
    <div className="confirmation-wrapper">
      ...
      <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
        ...
        <Link to="/products" className="btn btn-outline">Continua cumparaturile</Link>
      </div>
