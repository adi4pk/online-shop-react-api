    ...
    <div className="container">
      <div className="section" style={{ paddingBottom: "0" }}>
        ...
        <div className="section-subtitle">
          <span id="cart-count-label">3 produse</span> in cos
        </div>
      </div>
      ...
      <div id="cart-empty" className="empty-state" style={{ display: "none", margin: "24px 0 40px" }}>
        ...
        <Link to="/products" className="btn btn-primary">Vezi produsele</Link>
      </div>
      ...
      <div id="cart-with-items">
        ...
        <div className="cart-layout">
          <div className="cart-items">
            <div className="cart-item" data-name="Laptop ProMax 15">
              ...
              <div className="cart-item-info">
                <div className="cart-item-name">Laptop ProMax 15</div>
                <div className="cart-item-sku">SKU-EL-001</div>
              </div>
            ...
            <div className="cart-item" data-name="Tricou Sport Dry-Fit">
              <div className="cart-item-img">👕</div>
              <div className="cart-item-info">
                <div className="cart-item-name">Tricou Sport Dry-Fit</div>
                <div className="cart-item-sku">SKU-CL-010</div>
              </div>
              <div className="cart-item-qty">
                <button>-</button>
            ...
            <div className="cart-item" data-name="Minge Fotbal Pro">
              <div className="cart-item-img">⚽</div>
              <div className="cart-item-info">
                <div className="cart-item-name">Minge Fotbal Pro</div>
                <div className="cart-item-sku">SKU-SP-015</div>
              </div>
              <div className="cart-item-qty">
                <button>-</button>
                <input type="number" defaultValue={1} min={1} />
          ...
          <div className="cart-summary">
            ...
            <Link to="/products" className="btn btn-ghost btn-block" style={{ marginTop: "8px" }}>
