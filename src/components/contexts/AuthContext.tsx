...
interface AuthContextType{
    ...
    loginnn:(body: LoginRequest) => void;
    logouttt:() => void;
    registerrr:(body: RegisterRequest)=> void;
...
export function AuthProvider({children}:AuthProviderProps){
    ...
    return(<AuthContext.Provider value={{user, setUser, registerrr, loginnn, logouttt}}>{children}</AuthContext.Provider>)
}
